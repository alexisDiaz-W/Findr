...
const Profiles: React.FC = () => {
    ...
    const RightSideBar = () => (
        <div className="px-5 sticky top-0 z-20 h-screen xl:w-[400px] flex-col gap-12 overflow-auto pl-6 lg:block">
            ...
            <div className="flex flex-col gap-5">
                <h3 className="text-white text-3xl font-bold leading-6">Sponsored</h3>
                <Image src="/assets/apt1.png" alt="ad" width={280} height={200} className="rounded-lg" />
            ...
            <div className="flex justify-center mt-4">
                <Link href="/AddProfile" passHref className="px-4 py-2 bg-green-600 text-white rounded
        ...
        <div className="bg-gray-800 min-h-screen py-8 ">
            <div className="pt-2 flex justify-between">
                ...
                <div className="flex-grow mx-auto max-w-5xl">
                    <ul role="list" className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-10 px-4 lg:px-0">
                        {profiles.map((profile, index) => (
                            <li key={index} className="bg-white shadow-2xl overflow-hidden rounded-lg profile-card min-h-[550px]">
                                <div className="flex flex-col items-center p-6 space-y-4">
                                    <Image width={280} height={200} className="flex-none rounded-full object-cover" src={profile.imageUrl} alt={profile.name} />
