...
const Profiles: React.FC = () => {
  ...
  useEffect(() => {
    ...
    console.log("Profiles loaded from storage:", storedProfiles); // This logs the profiles as they are initially loaded from storage
  }, []);
  ...
  const filteredProfiles = profiles.filter(profile => {
    ...
    return matchesOnlineStatus && matchesInterests && matchesGender;
  });
