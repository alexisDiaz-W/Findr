...
const SignUpForm: React.FC = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-100">
      <Link href="/" passHref>
        <h4 className="dark:text-blue-500 jura text-4xl text-black cursor-pointer ml-4 mt-4">
          Fr
        </h4>
      </Link>
      ...
      <form
        className="flex flex-col items-center justify-center p-8 grow text-black"
        onSubmit={onSubmit}
      >
        ...
        {companyError && (
          <span className="text-red-500 text-sm">{companyError}</span>
        )}
